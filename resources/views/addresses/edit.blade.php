            ...
            <div class="card card-profile pb-4">
              ...
              <div class="row email-edit mt-4 mb-2">
                ...
                <div class="col-8 col-lg-9 col-xl-9 d-flex justify-content-start">
                  <input class="form-control @error('address') is-invalid @enderror" type="text" name="address" value="{{auth()->user()->address->address}}">
                </div>
              ...
              <div class="row nombre-edit mb-2">
                ...
                <div class="col-8 col-lg-9 col-xl-9 d-flex justify-content-start">
                  <input class="form-control @error('city') is-invalid @enderror" type="text" name="city" value="{{auth()->user()->address->city}}">
                </div>
                <div class="col-12 mb-2" style="color: #e03232; background-color: color: #f8d7da;">
                  @error('city')
                          {{ $message }}
              ...
              <div class="row apellido-edit mb-2">
                ...
                <div class="col-8 col-lg-9 col-xl-9 d-flex justify-content-start">
                  <input class="form-control @error('province') is-invalid @enderror" type="text" name="province" value="{{auth()->user()->address->province}}">
                </div>
                <div class="col-12 mb-2" style="color: #e03232; background-color: color: #f8d7da;">
                  @error('province')
                          {{ $message }}
