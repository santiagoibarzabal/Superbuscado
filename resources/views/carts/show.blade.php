  ...
  <section class="container container-index">
    <div class="row">
      ...
      <div class="col-12 col-lg-6">
        ...
        @if(auth()->user()->address->zip_code == $q->store_zip_code)
        @if($list->id == $q->listing_id)
        @if($q->store_id == $storeId->id)

        <div class="card card-market">
          <div class="d-flex align-items-center">
            <div class="icon-market mr-3" style="background-image: url({{asset($q->logo)}})"></div>
            <p class="mb-0 market-select"><b>{{$q->market_name . '/'}}</b> {{$storeId->address . ' (' . $storeId->zip_code . ')'}}</p>
          </div>
        </div>
        ...
        <div class="detalle-orden">
          ...
          @foreach ($queryShow as $qs)
          @if(auth()->user()->address->zip_code == $qs->store_zip_code)
          @if($list->id == $qs->listing_id)
          @if($qs->store_id == $storeId->id)

          <div class="d-flex">
            <div class="p-2 ml-2 flex-grow-1">
              <b>{{$qs->product_name}}</b>
            </div>
            <div class="p-2">
              {{$qs->product_quantity}}
          ...
          <div class="d-flex">
            <div class="p-2 mb-2 ml-2 flex-grow-1 total-price">
              <b>Total a pagar</b>
            </div>
            ...
            <div class="p-2 mb-2 mr-2 total-price">
              <b>{{'$' . $q->total_price}}</b>
            </div>
